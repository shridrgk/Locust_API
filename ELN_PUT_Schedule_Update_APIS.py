...
class ELN(HttpUser):
    ...
    def updateSchedule(self):
        taskBodyData = open('UpdateSchedule.json')
        taskBody = json.load(taskBodyData)
        taskBody['subject'] = 'Updated' + str(self.counterNum())

        with self.client.put('/eln-project-mgmt-svc-nfr/v1/UserScheduleTask/update/20', name='UpdateIDSchedule', catch_response=True,
