...
class ELN(HttpUser):
    ...
    def GetToken(self):
        ...
        with self.client.get('/eln-authz-svc-nfr/v1/Security/9a58debe-4ac0-47c3-b36c-edb5813ac0ac 9a58debe-4ac0-47c3-b36c-edb5813ac0ac/token', name='GetToken', catch_response=True,
